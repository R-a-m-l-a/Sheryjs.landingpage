...
.addEventListener("click", function(){
   if(!animating){
    ...
    }); //here we convert the whole headings into an array form each represeneted by an index,i-e we are animating the first index of the array using gsap
